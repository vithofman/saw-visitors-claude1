 ...
 * 
 * Kompletní wrapper pro admin tabulku - kopíruje design z customers-list.php
 * 
...
<div class="saw-card">
    ...
    <div class="saw-card-body" id="saw-<?php echo esc_attr($entity); ?>-container">
        ...
        <?php 
        // Include table body
        include SAW_VISITORS_PLUGIN_DIR . 'templates/admin-table/table-body.php'; 
        ?>
        
        <?php 
        // Include pagination
        if ($config['total_pages'] > 1) {
            include SAW_VISITORS_PLUGIN_DIR . 'templates/admin-table/table-pagination.php';
        }
        ?>
    </div>
</div>
