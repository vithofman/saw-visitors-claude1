...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // Hide page loader overlay (loader HTML is in layout template)
        document.body.classList.add('loaded');
        document.body.classList.add('saw-loaded');

        // Remove loader element after CSS transition completes
        setTimeout(function () {
            var loader = document.getElementById('sawPageLoader');
