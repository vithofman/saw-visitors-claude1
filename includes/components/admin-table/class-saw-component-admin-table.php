...
class SAW_Component_Admin_Table {
    ...
    private function render_floating_button() {
        ...
        // Detail mode - FAB buttons are now rendered INSIDE sidebar via detail-sidebar.php
        // This method no longer renders FAB for detail mode
        if ($sidebar_mode === 'detail' && !empty($this->config['detail_item'])) {
            return; // FAB rendered in detail-sidebar.php
        }
