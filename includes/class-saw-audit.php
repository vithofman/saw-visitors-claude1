<?php
/**
 * Audit Logger pro SAW Visitors
 * 
 * Loguje všechny důležité akce do audit_log tabulky
 * 
...
class SAW_Audit {
    ...
    public static function log( $data ) {
        ...
        // Auto-detect IP a user agent pokud nejsou zadány
        ...
        // Převést details na JSON pokud je to array
        ...
        if ( ! $result ) {
            // Pokud se nepodaří logovat do DB, zaloguj do error_log
            error_log( sprintf(
    ...
    public static function count_logs( $args = array() ) {
        ...
        // WHERE conditions (stejné jako get_logs)
        $where = array( '1=1' );
        $where_values = array();
