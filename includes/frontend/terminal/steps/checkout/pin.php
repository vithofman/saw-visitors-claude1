<?php
/**
 * Terminal Step - Checkout via PIN (Unified Design)
 * 
...
$translations = [
    ...
    'sk' => [
        'title' => 'Odhlásenie - PIN kód',
        'subtitle' => 'Zadajte PIN kód z vašej návštevy',
        'submit' => 'Načítať návštevu',
    ],
    'uk' => [
...
/* Header */
.saw-checkout-pin-header {
    text-align: center;
    margin-bottom: 1.5rem;
}

.saw-checkout-pin-icon {
    font-size: 3rem;
...
<div class="saw-checkout-pin-aurora">
    <div class="saw-checkout-pin-content">
        
        <!-- Header -->
        <div class="saw-checkout-pin-header">
            <div class="saw-checkout-pin-icon">🔐</div>
            <h1 class="saw-checkout-pin-title"><?php echo esc_html($t['title']); ?></h1>
            <p class="saw-checkout-pin-subtitle"><?php echo esc_html($t['subtitle']); ?></p>
        </div>
        ...
        <div class="saw-pin-numpad">
            ...
            <button type="button" class="saw-pin-numpad-btn clear">CLR</button>
            ...
            <button type="button" class="saw-pin-numpad-btn backspace">⌫</button>
        </div>
...
<?php
error_log("[CHECKOUT-PIN.PHP] Unified design loaded (v3.3.0)");
?>