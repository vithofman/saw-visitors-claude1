            ...
            <div class="saw-action-grid">
                ...
                <button type="submit" 
                    ...
                    <div class="saw-action-text">
                        ...
                        <div class="saw-action-name-full">(<?php echo esc_html($t['checkin_full']); ?>)</div>
                ...
                <button type="submit" 
                    ...
                    <div class="saw-action-text">
                        ...
                        <div class="saw-action-name-full">(<?php echo esc_html($t['checkout_full']); ?>)</div>
