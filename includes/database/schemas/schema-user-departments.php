<?php
/**
 * Schema: saw_user_departments
 * M:N vztah mezi manažery a odděleními
 * @version 4.6.1
 */
...
function saw_get_schema_user_departments( $table_name, $prefix, $charset_collate ) {
	...
	return "CREATE TABLE {$table_name} (
		...
		customer_id BIGINT(20) UNSIGNED NOT NULL COMMENT 'Redundantní, ale pomáhá',
		user_id BIGINT(20) UNSIGNED NOT NULL,
		department_id BIGINT(20) UNSIGNED NOT NULL,
		is_primary TINYINT(1) DEFAULT 0 COMMENT 'Primární oddělení manažera',
	...
	) {$charset_collate} COMMENT='M:N: manažeři ↔ oddělení';";
}
